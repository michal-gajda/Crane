...
dotnet new sln --name Crane
```

```powershell
dotnet new classlib --framework net10.0 --output src/Domain --name Crane.Domain
dotnet sln add src/Domain
```

```powershell
dotnet new classlib --framework net10.0 --output src/Application --name Crane.Application
...
```powershell
dotnet new classlib --framework net10.0 --output src/Shared --name Crane.Shared
dotnet sln add src/Shared
```

```powershell
dotnet new classlib --framework net10.0 --output src/Infrastructure --name Crane.Infrastructure
...
```powershell
dotnet new mstest --framework net10.0 --output tests/Application.FunctionalTests --name Crane.Application.FunctionalTests
...
```powershell
dotnet new webapi --framework net10.0 --no-https --use-program-main --use-controllers --output src/WebApi --name Crane.WebApi
